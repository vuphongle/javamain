...
public class GUI_JTableNhanVien extends JFrame implements ActionListener, MouseListener, WindowListener {
	...
	public GUI_JTableNhanVien(PhongBan pb) {
	...
	public static void main(String[] args) {
		new GUI_JTableNhanVien(phongBan).setVisible(true);
	}
